...
from dinov2.eval.utils import ModelWithNormalize, evaluate, extract_features, evaluate_knn
...
def eval_knn(
    ...
    _, results_dict = evaluate_knn(model_with_knn, val_dataloader, postprocessors, metrics, device, clf=clf, raw_model=model)
...
def eval_knn_with_model(
    ...
    if distributed.is_main_process():
        for knn_ in results_dict_knn.keys():
            ...
            logger.info(f"{knn_} classifier result: Top1: {top1:.2f} ")
...
if __name__ == "__main__":
    ...
    args.output_dir = f"/data/zxq/DermINO/downstreams/retrieval/output_dir/{dataset_type}"
    args.nb_knn = [5,10,15]
