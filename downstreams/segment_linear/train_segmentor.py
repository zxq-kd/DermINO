...
def main(args):
    ...
    scheduler = optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=epochs)  # T_max 表示周期
...
if __name__ == "__main__":
    ...
    args.output_dir = os.path.join("/data/zxq/DermINO/downstreams/segment_linear/output_dir", args.dataset_type) 
